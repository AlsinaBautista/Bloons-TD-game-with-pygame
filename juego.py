...
icono = pygame.image.load("imgs/icono_globos.jpeg")
...
test_tower = Tower(pos=(370, c.height//2), scope=100, damage=1, att_speed=500, target=None, price=50, image=tower_img)
